...
const ValidatorSchema = new mongoose_1.Schema({
    validatorId: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true },
...
const DelegatorSchema = new mongoose_1.Schema({
...
exports.default = mongoose_1.default.model("Delegator", DelegatorSchema, "delegators");
